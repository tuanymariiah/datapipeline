...
module "bucket-raw" {
  ...
  name       = "data-pipeline-stack-combustiveis-brasil-raw01"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-curated" {
  ...
  name       = "data-pipeline-stack-combustiveis-brasil-curated01"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-pyspark-tmp" {
  ...
  name       = "data-pipeline-stack-combustiveis-brasil-pyspark-tmp01"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-pyspark-code" {
  ...
  name       = "data-pipeline-stack-combustiveis-brasil-pyspark-code01"
  project_id = var.project_id
  location   = var.region
}